        ...
        function successCallBack4(res) {
            ...
            if (typeof(res.result) !== "undefined") {
                ...
                frmHome.tabHome.tabMyEvent.segMyEvents.widgetDataMap = {
                    "lblEventName": "name",
                    "LocationCont": "location",
                    "lblRank": "users_rank",
                    "lblPoints": "user_scores"
                };
                frmHome.tabHome.tabMyEvent.segMyEvents.setData(obj);
            } else {
                frmHome.tabHome.tabMyEvent.segMyEvents.isVisible = false;
            }
            //  alert("myevent");
...
function eventDetailMyEvent() {
    ...
    var i = " " + parseInt(row);
    var x = i.trim();
    frmMyEventDetailed.ScheduleSeg.widgetDataMap = {
...
function userInfo() {
    if (kony.net.isNetworkAvailable(constants.NETWORK_TYPE_ANY)) {
        ...
        function successCallBackUserInfo(res) {
            ...
            //alert(res);
            // alert("Rank is "+res.result[0].rank);
