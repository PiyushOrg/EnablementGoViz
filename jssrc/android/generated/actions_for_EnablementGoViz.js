...
function AS_Button_0633fbfd53b8470ea0acfae30734f4e4(eventobject) {
    frmLogin.show();
}
...
function AS_Button_28a5ebd93d7b4215972922f77f81ab50(eventobject) {
    return eventEnroll.call(this);
}

function AS_Button_38dcd9b1943f4ce2af8b806e73411811(eventobject) {
    return onRateClick.call(this);
}
...
function AS_Button_684929d1c4bd455f9f875eea2ab96cda(eventobject) {}
...
function AS_Button_95ff54a72e414f4eb6d30b4ed30ce4a5(eventobject) {
    return rateSubmit.call(this);
}
...
function AS_Button_a51c83099c6e46bc8452337784d321c9(eventobject) {
    frmLogin.show();
}

function AS_Button_a884707aea9947d487ce884aae03b566(eventobject) {
    login();
}

function AS_Button_bed0d7ab72304d49bf7f874a341ba26b(eventobject) {
    frmLogin.show();
}

function AS_Button_c90ef03916344c4294a22d00e30b8481(eventobject) {
    return rateSubmit.call(this);
}

function AS_Button_d810e5fa96554bd69efe2b86912c858e(eventobject) {
    frmLogin.show();
}
...
function AS_Button_fef44746a52d4b6683e49299d5f124d2(eventobject) {
    frmLogin.show();
}
...
function AS_FlexContainer_6a92f6e57b11492b995135f210769b39(eventobject) {
    return onclickNull.call(this);
}
...
function AS_Form_22ab54dab0c14f7fb670c3128537b3d2(eventobject, x, y) {
    frmSlide2.show();
}

function AS_Form_34e4e5a98c484215b4d5f1c8e926ef11(eventobject, x, y) {
    frmSlide5.show();
}

function AS_Form_55edb0dc1055436c9bf3fe12dba3fa35(eventobject) {}

function AS_Form_5da78e1e0b4a427db3c3c5b7c46583d6(eventobject, x, y) {
    frmSlide3.show();
}
...
function AS_Form_e9120bd7d3f645ee8d6aa85c12427582(eventobject, x, y) {
    frmSlide4.show();
}

function AS_Form_f6e9f608109b448b9782345c6e49e94b(eventobject, x, y) {
    frmLogin.show();
}

function AS_Image_52652cf78e25463aa7312215d04774b3(eventobject, x, y) {
    return Rateit.call(this, eventobject.id);
}

function AS_Image_593cda34319b4809839b68392c53fa22(eventobject, x, y) {
    return Rateit.call(this, eventobject.id);
}

function AS_Image_746d186f575946deb3b6758aab87b427(eventobject, x, y) {
    return Rateit.call(this, eventobject.id);
}

function AS_Image_f56399a3f3754147930cf41467dc643d(eventobject, x, y) {}
...
function AS_Tab_8fea5489f535407c84f31bbfafc7e05f(eventobject) {
    frmHome.lblLine.isVisible = false;
    frmHome.lblline1.isVisible = true;
}

function AS_Tab_eb03912aca8e4555b895ded6685e1304(eventobject) {
    frmHome.lblLine.isVisible = true;
    frmHome.lblline1.isVisible = false;
